...
ROOT_URLCONF = 'recifegrafica.urls'
...
WSGI_APPLICATION = 'recifegrafica.wsgi.application'
...
] + get_core_apps(['recifegrafica.shipping', 'recifegrafica.checkout', 'recifegrafica.order'
